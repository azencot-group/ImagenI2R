...
def parse_args_regular():
    ...
    parser.add_argument('--tags', type=str, default=['0 missing rate'], help='tags for neptune logger', nargs='+')
...
def parse_args_irregular():
    ...
    # --- logging ---s
    parser.add_argument('--logging_iter', type=int, default=30, help='number of iterations between logging')
    parser.add_argument('--percent', type=int, default=100)
    parsed_args = parser.parse_args()
...
def parse_args_regular_transformer():
    """
    Parse arguments for regular transformer models
    Returns: regular generation args namespace
    """
    parser = argparse.ArgumentParser()
    # --- general ---
    parser.add_argument('--seed', type=int, default=0, help='random seed')
    ...
    # --- data ---
    parser.add_argument('--dataset', choices=['sine', 'energy', 'mujoco', 'stock', 'ETTh1', 'ETTh2', 'ETTm1', 'ETTm2', 'weather', 'electricity'], help='training dataset')
    ...
    parser.add_argument('--beta1', type=float, default=1e-5, help='value of beta 1')
    parser.add_argument('--betaT', type=float, default=1e-2, help='value of beta T')
    parser.add_argument('--diffusion_steps', type=int, default=18, help='number of diffusion steps (EDM)')
    parser.add_argument('--img_resolution', type=int, default=16, help='image resolution')
    parser.add_argument('--n_layer_enc', type=int, default=3, help='number of encoder layers')
    parser.add_argument('--n_layer_dec', type=int, default=6, help='number of decoder layers')
    parser.add_argument('--d_model', type=int, default=128, help='dimension of the hidden layer')
    parser.add_argument('--n_heads', type=int, default=4, help='number of attention heads')
    parser.add_argument('--dropout', type=float, default=0.1, help='dropout rate')
    parser.add_argument('--ema', type=bool, default=True, help='use ema')
    parser.add_argument('--ema_warmup', type=int, default=100, help='ema warmup')
    parser.add_argument('--gaussian_noise_level', type=float, default=0.0, help='noise level injected to the original data')
...
def parse_args_irregular_transformer():
    """
    Parse arguments for irregular transformer models
    Returns: irregular generation args namespace
    """
    parser = argparse.ArgumentParser()
    # --- general ---
    parser.add_argument('--seed', type=int, default=0, help='random seed')
