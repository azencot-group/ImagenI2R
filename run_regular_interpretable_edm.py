...
from utils.utils_args import parse_args_regular_transformer
from models.transformer_interpretable_edm import TSTransformerInterpretableEDM
...
def main(args):
    ...
    with CompositeLogger([NeptuneLogger()]) if args.neptune else PrintLogger() as logger:
        ...
        # Initialize the Interpretable Transformer EDM model
        model = TSTransformerInterpretableEDM(args=args, device=args.device).to(args.device)
...
if __name__ == '__main__':
    args = parse_args_regular_transformer()
